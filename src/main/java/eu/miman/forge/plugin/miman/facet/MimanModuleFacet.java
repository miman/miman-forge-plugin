...
/**
 *	Makes sure the project has the 'miman-root' as a parent project and that the version is correct.  
 * @author Mikael Thorman
 */
@Alias("miman-module-facet")
@RequiresFacet({ MavenCoreFacet.class, JavaSourceFacet.class,
	DependencyFacet.class })
public class MimanModuleFacet extends BaseFacet {
   ...
   private static ParentTypeType parentType;
   
   private NazgulPrjUtil nazgulPrjUtil;

	public MimanModuleFacet() {
		super();
	...
	private void installNazgulConfiguration() {
		...
		// TODO use the parentType to map to different types of parents
	...
	public static void setParentType(ParentTypeType parentType) {
		MimanModuleFacet.parentType = parentType;
	}
}
